...
/** Used to detect if a method is native. */
var reIsNative$1 = RegExp('^' + funcToString$2.call(hasOwnProperty$10).replace(reRegExpChar$1, '\\$&').replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$');
...
function hashHas$2(key) {
  var data = this.__data__;
  return nativeCreate$2 ? data[key] !== undefined : hasOwnProperty$13.call(data, key);
}
...
function equalArrays$2(array, other, bitmask, customizer, equalFunc, stack) {
  ...
  var index = -1,
      result = true,
      seen = bitmask & COMPARE_UNORDERED_FLAG$5 ? new SetCache$2() : undefined;
...
function baseIsArguments$2(value) {
  return isObjectLike$2(value) && baseGetTag$2(value) == argsTag$4;
}
...
/** Built-in value references. */
var propertyIsEnumerable$3 = objectProto$22.propertyIsEnumerable;
...
var isArguments$2 = baseIsArguments$2(function () {
  ...
  return isObjectLike$2(value) && hasOwnProperty$17.call(value, 'callee') && !propertyIsEnumerable$3.call(value, 'callee');
};
 ...
 * // => false
 */
var isBuffer$1 = nativeIsBuffer || stubFalse$2;
...
typedArrayTags$1[argsTag$5] = typedArrayTags$1[arrayTag$3] = typedArrayTags$1[arrayBufferTag$3] = typedArrayTags$1[boolTag$3] = typedArrayTags$1[dataViewTag$4] = typedArrayTags$1[dateTag$3] = typedArrayTags$1[errorTag$3] = typedArrayTags$1[funcTag$3] = typedArrayTags$1[mapTag$4] = typedArrayTags$1[numberTag$3] = typedArrayTags$1[objectTag$4] = typedArrayTags$1[regexpTag$3] = typedArrayTags$1[setTag$4] = typedArrayTags$1[stringTag$3] = typedArrayTags$1[weakMapTag$2] = false;
...
function arrayLikeKeys$2(value, inherited) {
  ...
  for (var key in value) {
    if ((inherited || hasOwnProperty$16.call(value, key)) && !(skipIndexes && (
    // Safari 9 has enumerable `arguments.length` in strict mode.
    key == 'length' ||
    // Node.js 0.10 has enumerable non-index properties on buffers.
    isBuff && (key == 'offset' || key == 'parent') ||
...
function isPrototype$2(value) {
  var Ctor = value && value.constructor,
      proto = typeof Ctor == 'function' && Ctor.prototype || objectProto$24;
...
var promiseCtorString$1 = toSource$2(Promise$2);
...
// Fallback for data views, maps, sets, and weak maps in IE 11 and promises in Node.js < 6.
if (DataView$2 && getTag$2(new DataView$2(new ArrayBuffer(1))) != dataViewTag$5 || Map$2 && getTag$2(new Map$2()) != mapTag$5 || Promise$2 && getTag$2(Promise$2.resolve()) != promiseTag$1 || Set$2 && getTag$2(new Set$2()) != setTag$5 || WeakMap$2 && getTag$2(new WeakMap$2()) != weakMapTag$3) {
...
function baseIsMatch$2(object, source, matchData, customizer) {
  ...
  while (++index < length) {
    ...
    if (noCustomizer && data[2]) {
      ...
      if (!(result === undefined ? baseIsEqual$2(srcValue, objValue, COMPARE_PARTIAL_FLAG$6 | COMPARE_UNORDERED_FLAG$4, customizer, stack) : result)) {
        return false;
      }
    }
  }
...
function isSymbol$2(value) {
  return typeof value == 'symbol' || isObjectLike$2(value) && baseGetTag$2(value) == symbolTag$3;
}
...
function baseMatchesProperty$2(path, srcValue) {
  ...
  return function (object) {
    ...
    return objValue === undefined && objValue === srcValue ? hasIn$2(object, path) : baseIsEqual$2(srcValue, objValue, COMPARE_PARTIAL_FLAG$11 | COMPARE_UNORDERED_FLAG$7);
  };
}
...
/** Used to check objects for own properties. */
var hasOwnProperty$19 = objectProto$25.hasOwnProperty;
...
function assignValue$2(object, key, value) {
  var objValue = object[key];
  if (!(hasOwnProperty$19.call(object, key) && eq$2(objValue, value)) || value === undefined && !(key in object)) {
 ...
 * @returns {Array} Returns the array of symbols.
 */
var getSymbolsIn = !nativeGetSymbols$2 ? stubArray$2 : function (object) {
  var result = [];
  while (object) {
...
/** Used to check objects for own properties. */
var hasOwnProperty$20 = objectProto$26.hasOwnProperty;
...
function getAllKeysIn(object) {
  return baseGetAllKeys$2(object, keysIn, getSymbolsIn);
}
...
function isPlainObject(value) {
  if (!isObjectLike$2(value) || baseGetTag$2(value) != objectTag$6) {
    return false;
  }
  ...
  var Ctor = hasOwnProperty$21.call(proto, 'constructor') && proto.constructor;
...
const buildObject = (vm, callback) => mapValues$2(vm.$options.forms, item => callback(isFunction$2(item) ? item.bind(vm)() : item));

// Convert schema object to data object
const createDataFromSchema = form => mapValues$2(omitBy(form, isFunction$2), item => {
  if (!isPlainObject(item)) return item;
  if (item.$each) {
    return item.$value || [];
  }
  let tmp = createDataFromSchema(item);
  return !Object.keys(tmp).length ? null : tmp.$value ? tmp.$value : omitBy(tmp, (item, key) => key.startsWith('$'));
});
...
var index = (Vue => {
  ...
  Vue.mixin({
    ...
    beforeCreate() {
      ...
      this.$form = name => mapValues_1(this.$forms, callback => (...args) => callback(name, ...args));
    }
  });
});
